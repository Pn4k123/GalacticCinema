...
namespace BookingMovieTicket.Services
{
    public class VnPayService : IVnPayService
    {
        ...
        string IVnPayService.CreatePaymentUrl(HttpContext context, VnPaymentRequestModel model)
        {
            ...
            var tongTien = model.donHang.ChiTietDonDatVes.Sum(ct => ct.GiaVe);
            ...
            vnpay.AddRequestData("vnp_IpAddr", MyUtil.GetIpAddress(context));
            vnpay.AddRequestData("vnp_Locale", _configuration["VnPay:Locale"]);
            vnpay.AddRequestData("vnp_OrderInfo", "Thanh toan ve phim: " + model.donHang.MaDon);
            vnpay.AddRequestData("vnp_OrderType", "other");
            vnpay.AddRequestData("vnp_ReturnUrl", _configuration["VnPay:PaymentBackReturnUrl"]);
            vnpay.AddRequestData("vnp_TxnRef", model.donHang.MaDon);
